...
var initConfig = function*(opts) {
        ...
        opts.session_timeout = opts.session_timeout || 24 * 60 * 60 * 1000
        opts.cache = opts.cache || './upload_files/cache'
        opts.block = opts.block || './upload_files/cache/block'
        opts.path = opts.path || ['./upload_files/a', './upload_files/b', './upload_files/c']
            //create data folder
        var paths = opts.path
