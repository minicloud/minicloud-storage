...
var initConfig = function*(opts) {
        ...
        opts.cache = opts.cache_path || path.resolve(process.cwd(), './upload_files/cache')
        opts.path = opts.storage_path || [path.resolve(process.cwd(), './upload_files/a'), path.resolve(process.cwd(), './upload_files/b'), path.resolve(process.cwd(), './upload_files/c')]
